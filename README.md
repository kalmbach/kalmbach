...
- [check if mononoki fonts are already present](https://github.com/kalmbach/nova/pull/6) on [kalmbach/nova](https://github.com/kalmbach/nova) (5 days ago)
- [Check if we need to update neovim config files](https://github.com/kalmbach/nova/pull/5) on [kalmbach/nova](https://github.com/kalmbach/nova) (5 days ago)
