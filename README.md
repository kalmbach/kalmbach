...
- [kalmbach/clone](https://github.com/kalmbach/clone) - bash script to clone all the repositories from a github account (8 months ago)
- [kalmbach/branch](https://github.com/kalmbach/branch) - interactive bash script to create git branches (8 months ago)
- [kalmbach/switch](https://github.com/kalmbach/switch) - interactive bash script to switch git branches (8 months ago)
- [kalmbach/nova](https://github.com/kalmbach/nova) - Opinionated Pop! OS Setup (9 months ago)
